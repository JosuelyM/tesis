...
\fxnote{En las subsecciones aun tienes mayúsculas. Por ejemplo, la 6.1. Se puede
ver del índice. Corrige.}
...
distintos orígenes y su uso con los elementos nativos del idioma\fxnote{La redacción 
de esta frase te quedo muy mal.}.  Para ello se
