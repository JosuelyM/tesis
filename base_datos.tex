...
\textbf{Conjunto base.} (1740-1899) Todas las migraciones que ocurran dentro de estos años se tomarán como verdaderas; por el momento en el presente trabajo no se indagará en el contenido que refieren a las migraciones dentro de este conjunto. \fxnote{Porque usas esos años? Y además, porque no hasta 1899?}
