...
\fxwarning{Listo ya los arregle}
...
más comunes del mismo,  cantidad que basta para conocer lo esencial del idioma~\fxnote{Este no es  el claim. Reformula}. \fxwarning{listo} Para el
...
menos dos idiomas\fxnote{no debes capitalizar las deficiones, proque no son nombres propios}.  
\fxwarning{Entendido, no lo repito}
...
\fxwarning{Los habia puesto para que los items estuviesen en una pagina nueva, antes estaba uno al final de una pagina y el otro el comenzar la siguiente, ya al final le dare formato}
...
\end{enumerate}
\fxnote{Creo que convendría tener un par de ejemplos, como tablas o algo asi,  que incluyan palabras que migran razonablemente y otras que no, para uqe se entienda las limitaciones de la definicion. Esto recuerda que dio mucha lata.}
\fxwarning{Los ejemplos los puse más abajo dentro de esta seccion donde llamo a las ventajas y desventajas del metodo}
...
\fxwarning{Listo, use dos tipos de item, uno para ventajas y otro para desventajas}
...
poder observar todas las palabras encontradas. \fxnote{Ok, veo que pones algunos ejemplos.  Discutamos si ponemos algo aca como una tabla o no.}

\fxwarning{A mi se me hace practico ver solo unos ejemplos en el texto, y que el lector pueda consultar despues todas las palabras encontradas en un formato de tablas}
...
\fxwarning{yo hbaia puesto las italicas y en negritas para remarcar el concepto de palabras funcionales y de contenido. }


\section{Partición de datos} % {{{

\fxnote{No entiendo esta seccion }
\fxwarning{Ya la corregí, espero se entienda mejor}
-
