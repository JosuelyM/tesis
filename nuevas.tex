...
los idiomas que han influenciado a \textit{A}.  \cpnote{Josue, por favor revisa el 
uso de comas y punto y coma. Creo que no lo estas usando bien. También trata de ser
consistente con los tiempos de los verbos. Nota que en el punto paso usas ``Contando'',
luego ahora usas ``Tomar'' y luego ``Contando''. No es consistente. Porfa corrige 
este error y propaga. Dale una iterada a este capitulo.}
...
ideas. Perdon estar molestando tanto, pero de verdad esta dificil de leer y la tesis
no debe quedar asi.}
...
\cpnote{cuales ámbitos?}
como propagadores del movimiento de un grupo afín de palabras.
\cpnote{Como se propaga un movimiento? Creo que intetas adornar de mas las frases y no 
qeuda bien.}

Las relaciones entre las causas y las migraciones serán identificables a partir
