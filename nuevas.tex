...
dominante a aquel que transmite palabras hacia los demás y que estas perduran
en los receptores al menos dos años. En esta división \fxnote{division? No entendi\ldots}
se indagará
en el movimiento de las palabras, ya que de éste puede proporcionar
información acerca de la influencia de un idioma sobre otro. 

Establecer un método que proporcione un resultado al cual ligar la expresión
influencia  no es sencillo, ya que es ambiguo decir que algo es más o menos
influyente. Al momento, en la literatura no existe una serie de pasos a seguir
cuyo resultado final sea una cantidad que mida la influencia. Para llegar a
esta resolución \fxnote{ah? Otra palabra que no cuadra para nada\ldots}, se
requieren establecer nuevas condiciones en la base de
datos, y a partir de ellas trazar posibles caminos que lleven a relaciones y
resultados  con los cuales satisfacer una interpretación de la influencia \fxnote{No 
entiendo la ultima frase. Ten cuidado con los cambios. Siento que lo intentas hacer
un poco rococo y elegante, pero por tratar, pierdes precision. Creo qeu lo mas importante
en textos cientificos es ser preciso, ordenado y conciso.}.
...
\fxnote{Ya no entiendo que quieres lograr con el siguietne parrafo. No se cual es el 
mensaje principal. De nuevo ``teñir un panorama'' no me suena correcto. Hablemos de la
estructura de un parrafo y creo que tocara iterar de neuvo!!! Argh.}
Aludiendo al capítulo  anterior, el tratamiento de la base de datos brinda
información de los orígenes, los receptores y las palabras que migran de un
lado a otro; comenzando con estos elementos, un primer paso es identificar los
tiempos donde ocurren las migraciones. Antes de comprometer completamente al
tiempo, es conveniente hacer una clasificación dentro de los propios préstamos
para teñir un panorama más claro con el cual trabajar. 

Si se tiene una pareja de idioma origen \textit{A} e idioma receptor \textit{B} entonces se definen  a los préstamos de \textit{A} en
\textit{B} como \textbf{préstamos nuevos} a las  palabras que aparecen por primera vez en las más usadas del idioma \textit{B}.  

Esta definición conlleva a catalogar a los préstamos nuevos por el año en el cual aparecieron,  existiendo una cantidad variable de elementos en cada año. 
Recurriendo a los años comprendidos en el conjunto de búsqueda (1900-2009), existen tres posibilidades con las cuáles trabajar a los
cinco idiomas para llegar a un resultado que corresponda a la influencia; las distintas maneras son:
...
Una parte complementaria de interpretar la influencia es identificar posibles causas de carácter histórico que favorecen a las migraciones, es decir en un año de migración el significado de las palabras puede guardar alguna relación con un evento ocurrido en el mismo año  (o en los años al rededor de él),  esto es identificable ya que las palabras migrantes pueden pertenecer a un mismo campo semántico relacionado al  evento. Por ejemplo, la globalización y el acceso a la tecnología  por parte de mayores sectores de la población ha propiciado la migración  de palabras como \textit{internet}, \textit{computadora}, \textit{web}, \textit{email} o \textit{software}, mostrando que tanto globalización como el desarrollo tecnológico son ámbitos que ocasionaron una ola de palabras que se mueven de un origen a los receptores. 
...
Al tratar con idiomas, se espera que en los eventos estén comprometidos países, personajes o comunidades que hablen o utilicen las lenguas involucradas.  El asociar las palabras con sucesos ayudará a mostrar el alcance que tuvo un lenguaje al llegar a diferentes receptores, así como  el origen de la influencia y la forma en la que se propagó.

Al contar con datos que abarcan mas de cien años, se resalta que el brote de palabras en los receptores no es inmediato, el tiempo que le lleva a una palabra migrar a otro conjunto dependerá de la época en la que se origino el evento y de la propia relevancia del mismo.  \fxnote{Frase hiperlarga. Corrige.}
\fxwarning{Listo, puse un ejemplo para tratar de ser mas claro}
Por ejemplo, las palabras que migraron tras la revolución francesa (1789-1799) aparecieron en los diferentes receptores hasta veinte años después del evento, en cambio los términos tras la globalización de 1980 migran en los años inmediatos (no más de cinco), esta diferencia de tiempo se asocia a que la información circula a diferentes velocidades en las diferentes épocas. 
...
\fxwarning{listo}
\item El conteo de palabras nuevas se realizó en un periodo de 109 años (1900 - 2009) y por cada década comprendida en este tiempo, es decir  se mostrarán la cantidad de palabras que aparecieron en los 109 años y a la vez como se distribuye esta cantidad en las diferentes décadas. 
\item Se proporcionará en \cite{prestamos_nuevos} las listas  de préstamos nuevos entre cada idioma, agrupados por el año de aparición en el receptor.  Se especificará en el Anexo 1  la forma de leer estas listas.
\item En cada resultado y por cada par de idiomas se agregará un contexto enfatizado en los sucesos históricos que detonan e invlucran las migraciones. Esto permite omitir los resultados del punto 2 (ver  página [XXX] ), ya que al especificar los eventos y las palabras involucradas en el movimiento de  \textit{A} a \textit{B}, se esta cubriendo de manera implícita los términos a los que \textit{B} fue susceptible.
...
Se destaca el papel del inglés en las ultimas dos décadas como el idioma común para transmitir información; además de ser el exportador de palabras en campos como la tecnología, disciplina que aporta palabras a todos los receptores y que ha hecho posible la fluidez con la que se mueve a información, así mismo el poder económico,  ha hecho de países como los Estados Unidos una fuente donde surge nueva información que con el tiempo es exportada.

El alemán también ha acaparado las migraciones, se han distinguido dos causas de la relevancia de este idioma, la primera asociada al papel de Alemania donde la guerra permitió la comunicación de varias lenguas con el alemán, incluso después de que esta terminara; por otro lado el 
el protagonismo de personajes germanoparlantes en diferentes áreas permitió que el alemán se expandiera incluso en lenguajes que no son de su familia lingüística. 

Finalmente entre las tres lenguas romances,  su periodo de
apogeo e influencia se destaca por  diferentes áreas especificas más que  por eventos globales. En el francés e italiano  en la industria e historia de Francia e Italia mientras que en el español resaltan los conceptos médicos, en el francés de la industria.


El camino que se siguió no trajo un resultado convincente de la forma en que influye un idioma en otro,  pero  si mostró  que  la posible influencia esta basada y repercute  en eventos o áreas donde un idioma tiene un papel relevante. Se realizara otro método para lograr cuantificar la influencia de unos sobre otros. 
