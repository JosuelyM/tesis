...
\begin{figure}[h!]
	...
	\caption{Palabras que migran del francés a los demás idiomas y de los demás idiomas al francés. El alemán y el inglés son los idiomas que en promedio por cada década recibieron más palabras del francés  con 8 y 5 respectivamente,  el italiano con 3 y el español con 2 son los idiomas que menos palabras recibieron, a pesar de ser junto al francés lenguas romances. La primera y segunda guerra mundial son los campos semánticos más comunes en las migraciones den francés.}
	\label{fig.NC_FR}
	
	
\end{figure}

De la figura~\ref{fig.NC_FR} se puede ve que entre las décadas de 1920 y 1940, incrementaron las palabras que migraron del francés hacia  el inglés, el alemán y el italiano.  Entre estas décadas ocurrieron las dos guerras mundiales, donde España no participo y donde el español no tuvo este incremento. 
