...
\item Para los resultados la influencia entre pares de idiomas (punto 3, página ~\pageref{proceso.nuevos}), se agregó un contexto de los sucesos relacionados con las migraciones. Esto permite observar que campos de \textit{A} influenciaron a \textit{B}. 
...
\begin{figure}
	\centering
	\begin{tabular}{cccc}
		\includegraphics[width=0.33\textwidth]{BOR_EN.png} &
		\includegraphics[width=0.33\textwidth]{BOR_FR.png} &
		\includegraphics[width=0.33\textwidth]{BOR_GE.png} \\
		\textbf{(a)}  & \textbf{(b)} & \textbf{(c)}  \\[6pt]
	\end{tabular}
	\begin{tabular}{cccc}
		\includegraphics[width=0.33\textwidth]{BOR_IT.png} &
		\includegraphics[width=0.33\textwidth]{BOR_SP.png} \\
		\textbf{(d)}  & \textbf{(e)}  \\[6pt]
	\end{tabular}
	\caption{ 
		\textbf{(a)} Some text
