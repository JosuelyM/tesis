...
página ~\pageref{proceso.nuevos}), se agregó un contexto de los sucesos
relacionados con las migraciones. Esto permite observar que campos semánticos
favorecieron las migraciones\cpnote{afinar}. 
...
\item Las palabras mencionadas carecen de signos ortográficos y su escritura es
en minúsculas, ya que así provienen de la base de datos. 
...
siglo (1950). Después de 1980, el alemán ha obtenido en cada década 30 palabras
nuevas respecto a la década anterior; en consecuencia ha sido el mayor receptor
en los últimos treinta años. Al tratarse como idioma origen, el alemán dejo de
aportar tantas palabras después de 1940, nuevamente la década donde termino la segunda
guerra.
...
\begin{figure} % {{{
	\centering
	\includegraphics[scale=.32]{NC_EN.png}
...
\begin{figure}[h!]
	\centering
	\includegraphics[scale=.32]{NC_FR.png}
...
\begin{figure}
	\centering
	\includegraphics[scale=.32]{NC_GE.png}
...
\begin{figure}
	\centering
	\includegraphics[scale=.32]{NC_IT.png}
...
\begin{figure} % {{{
	\centering
	\includegraphics[scale=.32]{NC_SP.png}
