...
Las causas que originan las migraciones, serán identificables a partir del significado de los préstamos involucrados en un año de migración. 
De acuerdo a McGraw-Hill  \cite{mcgraw}, un  \textbf{campo semántico} es un conjunto de palabras asociadas que comparten parte de su significado. Entonces las palabras migrantes pueden estar relacionadas con un evento a partir de un campo semántico esto será identificable porque las migraciones ocurren en el mismo año (o en los años al rededor) donde el evento aconteció. 
...
\item Se agregará entre paréntesis, la traducción de los préstamos nuevos que migran de un idioma a otro, en caso de que está exista en el español. 
...
El francés y el alemán, como receptores mostraron resultados similares, ambos recibiendo casi la
misma cantidad de palabras en cada década desde comienzos del siglo XX hasta mediados del mismo. Después de 1980, el alemán ha obtenido en cada década 30 palabras nuevas respecto a la década anterior, en consecuencia ha sido el mayor receptor en los últimos treinta años. Al tratarse como idioma origen, el alemán redujo la cantidad de palabras que aportaba en 1950, nuevamente tras finalizar la segunda guerra.
...
que recibe es similar.  En las demás décadas, el español ha actuado primordialmente como un idioma receptor. 
...
De la figura~\ref{fig.NC_EN}, se puede ver que el inglés (con cualquier combinación) migró más palabras nuevas de las que recibió; las únicas excepciones se dieron  con el español en las décadas de 1910, 1940 y 1980. 
...
En las ultimas dos décadas, surgen términos referentes a la globalización y al desarrollo tecnológico, entre ellas \textit{standards} (estándar) (1983), \textit{market} (mercado) (1994), \textit{internet} (1996), \textit{economy} (economía)(1996), \textit{online} (en línea) (1998), \textit{value} (valor) (2001), \textit{financial} (financiera) (2003) y \textit{customer} (cliente) (2007). 
% }}}
...
En los últimos años, nuevamente la globalización, la tecnología y la economía, son áreas comunes para los préstamos del inglés, \textit{internet} (1996), \textit{business} (negocios) (2000) y \textit{marketing} (mercadeo) (2001), son ejemplos de ellas. 
...
El los últimos años, las palabras aluden a términos de la globalización y la tecnología  \textit{internet} (1995), \textit{mail} (correo) (1999), \textit{marketing} (mercadeo) (2001),  \textit{digital} (2002), \textit{software} (2004) y \textit{management} (administración) (2009).  
...
De la figura~\ref{fig.NC_FR} se puede ver que entre las décadas de 1920 y 1940,  incrementaron las palabras que migraron del francés en  el inglés, en el alemán y en el italiano. Las palabras que migran entre estas décadas son referentes a la Primera Guerra Mundial (que termino en 1918, año cercano a 1920) y a la Segunda Guerra Mundial (finalizada en la década de 1940). 
...
El alemán tuvo dos décadas entre 1920 y 1940  (años cercanos a las dos guerras mundiales), donde  fue el idioma que más palabras recibió del francés. Entre estos años se localizaron a \textit{diplomatie} (diplomacia) (1917), \textit{bourgeoisie} (burguesía) (1919), \textit{politique} (política) (1920)  \textit{guerre} (guerra) (1925), \textit{allemagne} (Alemania) (1925), \textit{russie} (Rusía) (1925) y \textit{empire} (imperio) (1937), palabras del campo semántico de la política y de países involucrados en las guerras. 
...
En la segunda mitad de siglo, las migraciones del alemán en los demás idiomas disminuyeron, salvo en la décadas de 1970 con el italiano y con el español, y en el 2000 con el español, siendo el alemán un idioma que recibió más palabras de las que migró. La derrota de Alemania en la Segunda Guerra Mundial fue un factor para que el alemán en la segunda mitad de siglo recibiera más palabras de las que migró, adaptándose a ámbitos culturales, políticos y económicos de los demás países. 
...
Se distinguieron dos campos comunes para los préstamos nuevos,  el primero referente a la historia del alemán en las guerras, \textit{kaiser} (emperador) (1915), \textit{reich} (imperio) (1921), \textit{hitler} (1933),  \textit{regierung} (gobierno), \textit{deutschen} (alemán), \textit{minister} (ministro) y  \textit{bestimmungen} (regulación) todas ellas en 1944. % (traducciones de gobierno, alemán, ministro y reglamentos).  
...
Entre los préstamos que migraron del alemán al italiano,  se encuentran palabras relacionadas con la guerra. Entre ellas \textit{reich} (imperio) (1930),  \textit{hitler} (1939), \textit{lenin} (1944) y \textit{berchtold} (1944); mientras que 
...
A pesar de que el español no estuvo involucrado en la segunda guerra mundial, sí migrarón a él terminos relacionados con el suceso.  Entre ellos \textit{kaiser} (emperador) (1938) y \textit{hitler} (1940). 
...
Las palabras que migran del italiano al alemán son del campo semántico de la Segunda Guerra Mundial. Estas son \textit{regime} (régimen) (1938), \textit{panzer} (blindado) (1941) y \textit{duce} (líder) (1942).
...
\begin{figure}[h!] % {{{
	...
	\caption{Palabras que migran del español a los demás idiomas y de los demás idiomas al español. El italiano es el idioma que más palabras recibe del español, en promedio 5 por cada década, seguido del francés con 3, mientras que el ingles y el alemán reciben 2. Los campos semánticos donde provienen los préstamos del español  más comunes en las migraciones del español son la medicina y los nombres de países latinoamericanos. }
	\label{fig.NC_SP}
\end{figure} % }}}


A pesar de que los países hispanohablantes no participaron en los conflictos bélicos del siglo pasado, la guerra afecto a la economía de estos países, ya que algunos de ellos tuvieron crisis en la posguerra. Estas migraciones se pueden ver en la figura~\ref{fig.NC_SP} entre las décadas de 1920 y 1940.
