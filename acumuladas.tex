...
De la figura~\ref{fig.UO_GE} se puede ver que el uso del alemán en el inglés, y en el alemán al italiano disminuyó a partir de 1960, mientras que en el español fue desde 1940. Los préstamos del alemán que disminuyeron su influencia en los tres idiomas, son del campo semántico de la guerra. Además de los mencionados entre el alemán y el inglés de la página~\pageref{D-EN}, se encuentran \textit{marx}, \textit{testen} y \textit{reich}
