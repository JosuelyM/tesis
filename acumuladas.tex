...
\begin{figure}
	\centering
	\begin{tabular}{cc}
		\includegraphics[width=0.5\textwidth]{UO_EN.png} &
		\includegraphics[width=0.5\textwidth]{UR_EN.png}  \\
		\textbf{(a)}  & \textbf{(b)} 
	\end{tabular}

	\begin{tabular}{c}
		\includegraphics[width=\textwidth]{U_EN.png} \\
		\textbf{(c)}
	\end{tabular}
	\caption{ 
		\textbf{(a)} Some text
...
\begin{figure}%[h!]
	\centering
	\includegraphics[scale=.36]{UO_EN.png}
	\label{fig.ST_a_EN}
...
\begin{figure}%[h!]
	\centering
	\includegraphics[scale=.36]{UR_EN.png}
	\label{fig.ST_b_EN}
