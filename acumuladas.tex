...
\begin{itemize}
	...
	\item Se realizó otro tipo de grafica, mostrando el uso de \textit{A} en \textit{B} y el de \textit{B} en \textit{A}. Estas graficas se anexarán en la sección~\ref{palabras.acumuladas.apendice} del Apéndice A.
