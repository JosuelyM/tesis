...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\frontmatter
\include{Agradecimientos/cita}          % Comentar línea si no se usa
...
\include{introduccion}            % ~10 páginas - Explicar el propósito de la tesis
\include{base_datos}

\include{nuevas}

%\include{Capitulo2/marco_teorico}           % ~20 páginas - Poner un contexto a la tesis, hacer referencia a trabajos actuales en el tema
\include{acumuladas}      % ~20 páginas - Explicar el problema en específico que se va a resolver, la metodología y experimentos/métodos utilizados
\include{diversidad}            % ~5 páginas - Resumir lo que se hizo y lo que no y comentar trabajos futuros sobre el tema
\include{omision} 
