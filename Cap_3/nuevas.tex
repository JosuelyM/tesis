...
aparición.  \fxnote{no se por qué aclaras eso del año. }

\fxnote{elimine la otra frase que rectificaba lo del año, estaba repitiendo}
...
\item Tomar ahora a \textit{A} \fxnote{notaras con italica el idioma? No eres
consistente. Acordemos y así ya puedo corregir} 
\fxnote{Si, error al escribir aqui, cada que mencione al idioma A, B o C, lo pondre en italicas}
...
\fxnote{Se me ocurre por ahí de trabajo a futuro estudiar la velocidad de propagación de la información usando tus datos. Que opinas?}

En cada resultado posterior, se hizo un análisis histórico de las
palabras que conforman los préstamos nuevos entre idiomas\fxnote{Quizá cambiar investigación por análisis. Una investigacion suena como algo asi serio.}. En la mayor parte
...
\end{itemize}
\fxnote{Veo un numero en la bibliografia despues de la referencia, en todas las
referencias. Que es eso?}

\fxnote{El numero al final de cada referencia indica la pagina en la que se encuentra la referencia. }
% }}}
