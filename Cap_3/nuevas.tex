...
en los receptores al menos dos años\fxnote{No veo donde 
dices lo de los dos años.}.   El objetivo ahora es identificar qué
...
\fxnote{Me gusta el espíritu de la discusión acá, pero no esta bien lograda. Itera.}.
...
\fxnote{no se por qué aclaras eso del año. }
...
} como el idioma receptor, y contando cuántos
...
\fxnote{Se me ocurre por ahí de trabajo a futuro estudiar la velocidad de propagación de
la información usando tus datos. Que opinas?}
